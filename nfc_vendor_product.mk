...
ifeq ($(call is-board-platform-in-list, sun canoe bengal chora malabar lahaina taro),true)
...
PRODUCT_COPY_FILES += \
    ...
    vendor/nxp/opensource/halimpl/snxxx/halimpl_v2/conf/SN300/gen-config-files/libnfc-nci.conf:$(TARGET_COPY_OUT_VENDOR)/etc/libnfc-nci.conf
